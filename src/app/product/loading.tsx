  ...
  return (
    <div className="flex flex-col p-5">
      ...
      <div className="mt-5 flex flex-col gap-1">
        ...
        <Skeleton className="flex h-[16px] w-[88px] items-center justify-center rounded-lg" />
        <Skeleton className="flex h-[10px] w-[70px] items-center justify-center rounded-lg" />
      </div>
      <div>
